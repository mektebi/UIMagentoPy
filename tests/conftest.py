...
def browser(config):
  ...
  if config['browser'] == 'Firefox':
    driver = selenium.webdriver.Remote("http://127.0.0.1:4444/wd/hub", DesiredCapabilities.FIREFOX)
    ...
    driver = selenium.webdriver.Remote("http://127.0.0.1:4444/wd/hub", DesiredCapabilities.SAFARI)
